...
import com.cm.services.ItemPedidoService;
...
public class ItemPedidoResource {
	...
	public ResponseEntity<Void> create(@RequestBody ItemPedidoDTO itemPedidoDTO, @PathVariable Integer id ){
		itemPedidoDTO.setId(id);
		service.update(itemPedidoDTO);
		return ResponseEntity.noContent().build();
	}
